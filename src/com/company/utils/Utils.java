...
public class Utils {
    ...
    public static String readInputString() {
        BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(System.in)); // System.in should never be closed!
    ...
    public static String readNotEmptyInputString(String invitation) {
        String string;
